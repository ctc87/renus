function calculate(){
  const ERROR = "ERROR! Try something like '-4.2C' instead";
  var re_f = /[0-9]+[\s]*[º]*[f,farenheit]/i;
  var re_c = /[0-9]+[\s]*[º]*[c,celsius,centigrados]/i;
  var re_number =/-?[0-9]+\.[0-9]+|-?[0-9]+/;
